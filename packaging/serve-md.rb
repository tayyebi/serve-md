...
class ServeMd < Formula
  ...
  on_linux do
    on_intel do
      url "https://github.com/tayyebi/serve-md/releases/download/v0.8.0/serve-md-linux-x86_64"
      sha256 "REPLACE_WITH_SHA256"
    end
    on_arm do
      url "https://github.com/tayyebi/serve-md/releases/download/v0.8.0/serve-md-linux-aarch64"
      sha256 "REPLACE_WITH_SHA256"
    end
  end
  ...
  on_macos do
    ...
    url "https://github.com/tayyebi/serve-md/archive/refs/tags/v0.8.0.tar.gz"
    sha256 "REPLACE_WITH_SHA256"
  end
